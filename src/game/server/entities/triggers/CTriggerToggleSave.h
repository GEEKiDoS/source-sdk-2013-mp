...
#ifndef GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTOGGLESAVE_H
#define GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTOGGLESAVE_H
...
#endif // GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTOGGLESAVE_H
