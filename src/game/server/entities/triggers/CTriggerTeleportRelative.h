...
#ifndef GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORTRELATIVE_H
#define GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORTRELATIVE_H
...
#endif // GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORTRELATIVE_H
