...
#ifndef GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORT_H
#define GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORT_H
...
#endif // GAME_SERVER_ENTITIES_TRIGGERS_CTRIGGERTELEPORT_H
